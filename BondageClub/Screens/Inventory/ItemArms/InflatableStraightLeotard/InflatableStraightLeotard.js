...
function InventoryItemArmsInflatableStraightLeotardDraw() {
	...
	DrawText(DialogFind(Player, "InflatableStraightLeotardSelectTightness"), 1500, 500, "white", "gray");
	...
	DrawText(DialogFind(Player, "InflatableStraightLeotardPoseLight"), 1125, 800, "white", "gray");
	...
	DrawText(DialogFind(Player, "InflatableStraightLeotardPoseInflated"), 1375, 800, "white", "gray");
	...
	DrawText(DialogFind(Player, "InflatableStraightLeotardPoseBloated"), 1625, 800, "white", "gray");
	...
	DrawText(DialogFind(Player, "InflatableStraightLeotardMax"), 1875, 800, "white", "gray");
}
...
function InventoryItemArmsInflatableStraightLeotardSetPose(NewPose) {

	// Gets the current item and character
	var C = (Player.FocusGroup != null) ? Player : CurrentCharacter;
	if ((CurrentScreen == "ChatRoom") || (DialogFocusItem == null)) {
		DialogFocusItem = InventoryGet(C, C.FocusGroup.Name);
		InventoryItemArmsInflatableStraightLeotardLoad();
	}
	...
	CharacterRefresh(C);
	var msg = "InflatableStraightLeotardRestrain" + ((NewPose == null) ? "None" : NewPose);
	var Dictionary = [];
