...
function InventoryItemNipplesLactationPumpDraw() {
	...
	DrawText(DialogFind(Player, "SuctionPower" + DialogFocusItem.Property.SuctionLevel.toString()), 1500, 600, "White", "Gray");
	if(DialogFocusItem.Property.SuctionLevel > 0) DrawButton(1200, 650, 200, 55, DialogFind(Player, "off"), "White");
	if(DialogFocusItem.Property.SuctionLevel < 1) DrawButton(1550, 650, 200, 55, DialogFind(Player, "LowSuction"), "White");
	if(DialogFocusItem.Property.SuctionLevel > 1) DrawButton(1550, 650, 200, 55, DialogFind(Player, "LowSuction"), "White");
	if(DialogFocusItem.Property.SuctionLevel < 2) DrawButton(1200, 710, 200, 55, DialogFind(Player, "MediumSuction"), "White");
	if(DialogFocusItem.Property.SuctionLevel > 2) DrawButton(1200, 710, 200, 55, DialogFind(Player, "MediumSuction"), "White");
	if(DialogFocusItem.Property.SuctionLevel < 3) DrawButton(1550, 710, 200, 55, DialogFind(Player, "HighSuction"), "White");
	if(DialogFocusItem.Property.SuctionLevel > 3) DrawButton(1550, 710, 200, 55, DialogFind(Player, "HighSuction"), "White");
